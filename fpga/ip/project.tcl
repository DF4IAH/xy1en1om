...
#
# Generated by Vivado on Wed May 25 21:04:23 +0200 2016
...
#    "C:/Users/espero/git/DF4IAH_xy1en1om/fpga/rtl/red_pitaya_pll.sv"
...
#    "C:/Users/espero/git/DF4IAH_xy1en1om/fpga/sdc/red_pitaya.xdc"
...
# Create project
create_project xy1en1om_win ./xy1en1om_win
...
set files [list \
 ...
 "[file normalize "$origin_dir/../../../RedPitaya_RadioBox/fpga/bd/system.bd"]"\
...
set file "$origin_dir/../../../RedPitaya_RadioBox/fpga/bd/system.bd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7z010clg400-1 -flow {Vivado Synthesis 2015} -strategy "Flow_AreaOptimized_high" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7z010clg400-1 -flow {Vivado Implementation 2015} -strategy "Area_Explore" -constrset constrs_1 -parent_run synth_1
} else {
