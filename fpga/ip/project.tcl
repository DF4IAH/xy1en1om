...
#
# Generated by Vivado on Fri Aug 12 03:06:00 +0200 2016
...
#    "C:/Users/espero/git/DF4IAH_xy1en1om/fpga/ip/system.bd"
#    "C:/Users/espero/git/DF4IAH_xy1en1om/fpga/ip/fifo_32i_32o_512d/fifo_32i_32o_512d.xci"
...
#    "C:/Users/espero/git/DF4IAH_xy1en1om/fpga/sim/regs_sha256_tb_synth.wcfg"
#    "C:/Users/espero/git/DF4IAH_xy1en1om/fpga/sim/regs_sha256_tb_impl.wcfg"
#
#*****************************************************************************************
...
set files [list \
 ...
 "[file normalize "$origin_dir/../../../RedPitaya_RadioBox/fpga/bd/hdl/system_wrapper.v"]"\
 "[file normalize "$origin_dir/../rtl/red_pitaya_rst_clken.sv"]"\
 "[file normalize "$origin_dir/../rtl/regs.sv"]"\
 "[file normalize "$origin_dir/../rtl/top.sv"]"\
 "[file normalize "$origin_dir/../rtl/axi_pc2leds.v"]"\
 "[file normalize "$origin_dir/../rtl/keccak_f1600_round.sv"]"\
 "[file normalize "$origin_dir/../rtl/sha256_engine.sv"]"\
 "[file normalize "$origin_dir/adc_clk_pll/adc_clk_pll.xci"]"\
 "[file normalize "$origin_dir/system.bd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../rtl/red_pitaya_rst_clken.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "SystemVerilog" $file_obj

set file "$origin_dir/../rtl/regs.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "SystemVerilog" $file_obj
...
set file "$origin_dir/../rtl/keccak_f1600_round.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "SystemVerilog" $file_obj

set file "$origin_dir/../rtl/sha256_engine.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "SystemVerilog" $file_obj

set file "$origin_dir/adc_clk_pll/adc_clk_pll.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/fifo_32i_32o_512d/fifo_32i_32o_512d.xci"]"\
]
add_files -norecurse -fileset $obj $files
...
set file "[file normalize "$origin_dir/../sdc/project.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/../sdc/project.xdc"
set file [file normalize $file]
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/../sdc/project.xdc"]" $obj
...
set files [list \
 ...
 "[file normalize "$origin_dir/../tbn/regs_sha256_tb.sv"]"\
 "[file normalize "$origin_dir/../sim/regs_sha256_tb_behav.wcfg"]"\
 "[file normalize "$origin_dir/../sim/regs_sha256_tb_synth.wcfg"]"\
 "[file normalize "$origin_dir/../sim/regs_sha256_tb_impl.wcfg"]"\
]
add_files -norecurse -fileset $obj $files
...
set file "$origin_dir/../tbn/regs_sha256_tb.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property "file_type" "SystemVerilog" $file_obj
...
set obj [get_filesets sim_1]
set_property "top" "red_pitaya_hk_tb" $obj
set_property "transport_int_delay" "0" $obj
set_property "transport_path_delay" "0" $obj
set_property "xelab.nosort" "1" $obj
set_property "xelab.unifast" "" $obj
set_property "xsim.view" "C:/Users/espero/git/DF4IAH_xy1en1om/fpga/sim/regs_sha256_tb_behav.wcfg C:/Users/espero/git/DF4IAH_xy1en1om/fpga/sim/regs_sha256_tb_synth.wcfg C:/Users/espero/git/DF4IAH_xy1en1om/fpga/sim/regs_sha256_tb_impl.wcfg" $obj
